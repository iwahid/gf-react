...
import { Link } from 'react-router-dom' /* линк для роутера */
    ...
    <header className="header">
      <div className="container">
        <div className="header__inner">
          ...
          {/* По моему дизайну, лого используется только в одном месте, поэтому пока нет смысла выносить его в одтельный компонент */}
          <Link to="/home" className="logo header__logo">GF</Link>

          {/* само меню так же не является переиспользуемым, не может иметь своего состояния, по этому не выношу его в отдельный компонент */}
          ...
          <div className="header__user-block">
            ...
            <div className="user-block">
              ...
              {/* FIXME: заменить на линки. Добавить роуты */}
              <a className="user-block__item" href="#">
                <svg id="user" viewBox="0 0 16 16" fill="inherit" >
                  <path d="M16 13v3H0v-3c0-2.66 5.33-4 8-4s8 1.34 8 4zm-4.002-9c0 2.21-1.789 4-3.998 4a3.997 3.997 0 0 1-4-4c0-2.21 1.788-4 4-4 2.21 0 3.998 1.79 3.998 4zm-10.1 9v1.1H14.1V13c0-.64-3.13-2.1-6.1-2.1-2.968 0-6.1 1.46-6.1 2.1zM5.9 4a2.101 2.101 0 0 0 4.202 0A2.101 2.101 0 0 0 5.9 4z"></path>
                </svg>
              </a>
              <a className="user-block__item" href="#">
                <svg id="wish-list" viewBox="0 0 20 19">
              ...
              <a className="user-block__item" href="#">
                <svg id="cart" viewBox="0 0 21 20">
                  <path d="M16 16c-1.1 0-1.99.9-1.99 2s.89 2 1.99 2c1.099 0 2-.9 2-2s-.901-2-2-2zM4.008 18c0 1.1.89 2 1.99 2 1.102 0 2-.9 2-2s-.898-2-2-2c-1.1 0-1.99.9-1.99 2zM14.55 9H7.53l-.13-.27L5.16 4h12.15zM3.27 0H0v2H2l3.6 7.59-1.35 2.45c-.16.28-.25.61-.25.96C4 14.1 4.9 15 6 15h12v-2H6.42a.256.256 0 0 1-.25-.25l.03-.12L7.1 11h7.45c.75 0 1.409-.41 1.75-1.03l3.861-7.01-.16-.96H4.21z"></path>
                </svg>
              </a>
          ...
          <button className="header__mobile-menu-toggle" type="button" onClick={props.onclick}>Х</button>
          {/* 
          {mMenu? <MobileMenu></MobileMenu> : ""} */}
        </div>
      </div>
